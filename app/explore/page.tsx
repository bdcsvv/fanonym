    ...
    <div className="min-h-screen bg-[#0a0a0f] text-white">
      ...
      <main className="max-w-6xl mx-auto p-6">
        ...
        <input
          ...
          className="w-full p-4 bg-gray-800 border border-gray-700 rounded-xl mb-6 focus:border-teal-500 outline-none"
        />
            ...
            {filteredCreators.map((creator) => (
              ...
              >
                <div className="flex items-center gap-4">
                  <div className="w-14 h-14 bg-gradient-to-r from-teal-500 to-purple-500 rounded-full flex items-center justify-center text-xl font-bold">
