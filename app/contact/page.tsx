      ...
      <main className="relative z-10 pt-32 pb-20 px-6">
        <div className="mx-auto max-w-4xl">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-5 max-w-2xl mx-auto mb-16">
            {/* Phone */}
            <a
              href="https://wa.me/6281282955582"
              target="_blank"
              rel="noopener noreferrer"
              className="group rounded-2xl border border-white/10 bg-white/[0.03] backdrop-blur-sm p-6 text-center transition-all duration-300 hover:border-purple-500/30 hover:bg-purple-500/5 hover:scale-[1.02]"
            >
              <div className="w-14 h-14 rounded-2xl bg-purple-500/15 border border-purple-500/20 flex items-center justify-center mx-auto mb-4 group-hover:bg-purple-500/25 transition-colors">
                <svg className="w-6 h-6 text-purple-400" fill="none" stroke="currentColor" viewBox="0 0 24 24">
              ...
              <p className="text-purple-400 text-sm font-medium">081282955582</p>
              <p className="text-zinc-500 text-xs mt-2">WhatsApp</p>
            </a>

            {/* Address */}
            <div className="group rounded-2xl border border-white/10 bg-white/[0.03] backdrop-blur-sm p-6 text-center transition-all duration-300 hover:border-purple-500/30 hover:bg-purple-500/5">
              <div className="w-14 h-14 rounded-2xl bg-purple-500/15 border border-purple-500/20 flex items-center justify-center mx-auto mb-4 group-hover:bg-purple-500/25 transition-colors">
                <svg className="w-6 h-6 text-purple-400" fill="none" stroke="currentColor" viewBox="0 0 24 24">
